...
(function() {
  ...
  source.addEventListener('message', function(e) {
    var data, i, len, ref, ref1, ref2, results1, widget;
    ...
    if (((ref = lastEvents[data.id]) != null ? ref.updatedAt : void 0) !== data.updatedAt) {
      ...
      if (((ref1 = widgets[data.id]) != null ? ref1.length : void 0) > 0) {
        ...
        for (i = 0, len = ref2.length; i < len; i++) {
          widget = ref2[i];
          results1.push(widget.receiveData(data));
        }
        return results1;
      }
    }
...
(function() {
  ...
  Dashing.Graph = (function(superClass) {
    ...
    Graph.prototype.ready = function() {
      var container, height, max, width, x_axis, y_axis;
...
(function() {
  ...
  Dashing.Image = (function(superClass) {
    ...
    Image.prototype.ready = function() {
      return set_background_image(this.node, this.image);
    };
    ...
    set_background_image = function(node, image) {
      return node.children[0].style.backgroundImage = "url(" + image + ")";
    };
...
(function() {
  ...
  Dashing.Lecturelist = (function(superClass) {
    extend(Lecturelist, superClass);

    function Lecturelist() {
      this.nextItem = bind(this.nextItem, this);
      return Lecturelist.__super__.constructor.apply(this, arguments);
    }

    Lecturelist.prototype.ready = function() {
      this.currentIndex = 0;
    ...
    Lecturelist.prototype.onData = function(data) {
      var i;
      this.currentIndex = 0;
      i = 0;
      if (data.items.length === 0) {
        return this.set('empty', true);
      }
    };

    Lecturelist.prototype.startCarousel = function() {
      return setInterval(this.nextItem, 10000);
    };

    Lecturelist.prototype.nextItem = function() {
      var items;
      items = this.get('items');
      if (items) {
        return $(items[this.currentIndex]).fadeOut((function(_this) {
          return function() {
            $(_this.node).find(".progress span:last-child").removeClass('active');
            $(_this.node).find(".progress span:nth-child(" + _this.currentIndex + ")").removeClass('active');
            _this.currentIndex = (_this.currentIndex + 1) % items.length;
            if (_this.currentIndex === 0) {
              $(_this.node).find(".progress span:last-child").addClass('active');
            } else {
              $(_this.node).find(".progress span:nth-child(" + _this.currentIndex + ")").addClass('active');
            }
            return $(items[_this.currentIndex]).fadeIn();
          };
        })(this));
      }
    };
...
(function() {
  ...
  Dashing.Linklist = (function(superClass) {
    extend(Linklist, superClass);

    function Linklist() {
      return Linklist.__super__.constructor.apply(this, arguments);
    }

    Linklist.prototype.ready = function() {};

    Linklist.prototype.onData = function(data) {
      if (data.items.length === 0) {
        return this.set('empty', true);
      }
    };
...
(function() {
  ...
  Dashing.Multilist = (function(superClass) {
    extend(Multilist, superClass);

    function Multilist() {
      return Multilist.__super__.constructor.apply(this, arguments);
    }
  ...
  Dashing.Number = (function(superClass) {
    ...
    Number.accessor('arrow', function() {
      if (this.get('last')) {
        ...
        return $(this.node).find(".change-rate").addClass('hidden');
      }
    });
...
(function() {
  ...
  Dashing.NumberWithTarget = (function(superClass) {
    extend(NumberWithTarget, superClass);

    function NumberWithTarget() {
      return NumberWithTarget.__super__.constructor.apply(this, arguments);
    }

    NumberWithTarget.accessor('current', Dashing.AnimatedValue);

    NumberWithTarget.accessor('annual_target', Dashing.AnimatedValue);

    NumberWithTarget.accessor('ytd_target', Dashing.AnimatedValue);

    NumberWithTarget.accessor('ytd_percent', function() {
      var annual, diff, ytd;
      ytd = parseInt(this.get('ytd_target'));
      annual = parseInt(this.get('annual_target'));
      diff = ytd / annual * 100;
      if (diff < 100) {
        return "width: " + diff + "%";
      } else {
    ...
    NumberWithTarget.accessor('value_percent', function() {
      var annual, current, diff;
      current = parseInt(this.get('current'));
      annual = parseInt(this.get('annual_target'));
    ...
    NumberWithTarget.accessor('difference', function() {
      var current, diff, last;
      if (this.get('last')) {
        last = parseInt(this.get('last'));
        current = parseInt(this.get('current'));
    ...
    NumberWithTarget.accessor('arrow', function() {
      if (this.get('last')) {
        if (parseInt(this.get('current')) === parseInt(this.get('last'))) {
          return '';
        } else if (parseInt(this.get('current')) > parseInt(this.get('last'))) {
    ...
    NumberWithTarget.prototype.onData = function(data) {
      if (data.status) {
        $(this.get('node')).attr('class', function(i, c) {
          return c.replace(/\bstatus-\S+/g, '');
        });
...
(function() {
  ...
  Dashing.Pie = (function(superClass) {
    ...
    Pie.accessor('currency');

    Pie.prototype.onData = function(data) {
      $(this.node).fadeOut().fadeIn();
      return this.renderPie(data.value);
    };

    Pie.prototype.ready = function() {
      return this.renderPie(null);
    };

    Pie.prototype.render = function() {
      Pie.__super__.render.apply(this, arguments);
      return this.renderPie(null);
    };

    Pie.prototype.renderPie = function(data) {
      var arc, arcs, colours, currency, height, j, legend, len, pie, radius, sum, val, vis, width;
      if (!data) {
        data = this.get("value");
      }
      if (!data) {
      ...
      width = this.get("width") || 260;
      height = this.get("height") || 260;
      radius = this.get("radius") || 130;
      currency = this.get("currency");
      colours = this.get("colours") || ['#D60303', '#ff6700', '#F9BC26', '#67EF67', '#0DBC37', '#1dd3a7', '#2254f4', '#ef3aab', '#b13198'];
      $(this.node).children("svg").remove();
      vis = d3.select(this.node).append("svg:svg").data([data]).attr("width", width).attr("height", height).append("svg:g").attr("transform", "translate(" + radius + "," + radius + ")");
      ...
      legend = d3.select(this.node).append("svg:svg").attr("height", 180).attr("width", width).attr("x", 0).append("g").attr("class", "legend").attr("x", 0).attr("y", height + 30);
      return legend.selectAll('g').data(data).enter().append('g').each(function(d, i) {
        var g;
        g = d3.select(this);
        g.append("rect").attr("x", 0).attr("y", 17 + (i * 22)).attr("width", 12).attr("height", 12).attr("fill", colours[i]);
        return g.append("text").attr("x", 24).attr("y", 29 + (i * 22)).attr("width", 130).attr("fill", '#fff').attr("font-size", "15px").text(function(d, i) {
          return d.label + " - " + Batman.Filters.numberWithCurrency(d.value, currency) + " (" + Math.round(d.value / sum * 100) + '%)';
        });
      });
    };
...
(function() {
  ...
  Dashing.ProgressList = (function(superClass) {
    extend(ProgressList, superClass);
    ...
    ProgressList.prototype.ready = function() {
      var autopaginator;
      return;
      this.currentIndex = 1;
      this.list = new List("" + (this.get('node').id), {
        valueNames: ["label"],
        page: 10,
        plugins: [
          ListPagination({
      ...
      this.pages = Math.ceil(this.list.items.length / 10);
      autopaginator = setInterval(this.nextPage, 5000);
      $('.pagination a').attr('href', '');
      return $('.pagination a').click(function(event) {
        event.preventDefault();
        return clearInterval(autopaginator);
      });
    };

    ProgressList.prototype.nextPage = function() {
      if (this.currentIndex === this.pages) {
        this.currentIndex = 0;
      }
      this.list.show((this.currentIndex * 10) + 1, 10);
...
(function() {
  ...
  Dashing.Smallmeter = (function(superClass) {
    extend(Smallmeter, superClass);

    Smallmeter.accessor('value', Dashing.AnimatedValue);

    function Smallmeter() {
      Smallmeter.__super__.constructor.apply(this, arguments);
      this.observe('value', function(value) {
        return $(this.node).find(".meter").val(value).trigger('change');
      });
    }

    Smallmeter.prototype.ready = function() {
      var meter;
      meter = $(this.node).find(".meter");
      meter.attr("data-bgcolor", meter.css("background-color"));
      meter.attr("data-fgcolor", meter.css("color"));
...
(function() {
  ...
  Dashing.Travis = (function(superClass) {
    extend(Travis, superClass);
...
(function() {
  var convertCurrency, currencySymbol;

  if (window.console) {
    console.log("Yeah! The dashboard has started!");
  }

  convertCurrency = function(currency, value) {
    if (Dashing.currentCurrency === "EUR") {
      return value * 1.39986;
    } else if (Dashing.currentCurrency === "USD") {
      return value * 1.55911;
    } else if (Dashing.currentCurrency === "JPY") {
      return value * 187.274;
    } else if (Dashing.currentCurrency === "KRW") {
      return value * 1710.25;
    } else {
      return value;
    }
  };
  ...
  Dashing.on('ready', function() {
    Dashing.currentCurrency || (Dashing.currentCurrency = "GBP");
    $(window).bind('resize', (function(_this) {
      return function(event) {
        return Dashing.resize();
      };
    })(this));
    return Dashing.resize();
  });

  Dashing.resize = function() {
    var grid_height;
    grid_height = window.innerHeight - $('#company-header').height();
    return $('ul.grid').height(grid_height);
  };

  Batman.Filters.numberWithCurrency = function(num, currency) {
    var negative, str;
    if (isNaN(num)) {
      return num;
    }
  ...
  Dashing.setCurrency = function(currency) {
    Dashing.currentCurrency = currency;
    return Dashing.refreshAllWidgets();
  };

  Dashing.refreshAllWidgets = function() {
    ...
    for (i = 0, len = keys.length; i < len; i++) {
      ...
      results.push(Dashing.widgets[key][0].render());
    }
    return results;
  };
