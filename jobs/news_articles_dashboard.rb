...
SCHEDULER.every '10s', :first_in => Time.now + 10 do
  ...
  send_event 'comms-odi-value', current: NewsArticlesDashboard.value(2014, "ODI")
  ...
  send_event 'comms-opendata-value', current: NewsArticlesDashboard.value(2014, "OpenData")
